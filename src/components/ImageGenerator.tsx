    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12 relative">
          {/* API Settings button - hidden on mobile, shown on desktop */}
          <Button
            variant="outline"
            size="sm"
            onClick={handleSettingsClick}
            className="hidden lg:flex absolute top-0 right-4 border-border/50 hover:border-primary transition-colors items-center"
          >
        ...
        <div className="max-w-7xl mx-auto">
          {/* Desktop: Two Column Layout, Mobile: Single Column with specific order */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Left Column - Desktop: Prompt + Pro Tips, Mobile: Just Prompt (order-1) */}
            <div className="space-y-6 order-1">
              ...
              {/* Pro Tips Section - Hidden on mobile, shown on desktop */}
              <Card className="hidden lg:block bg-gradient-to-br from-red-50 via-blue-50 to-yellow-50 border-red-200 shadow-lg">
                <div className="p-6">
                  <div className="space-y-4">
            ...
            {/* Right Column - Image Preview (order-2 on mobile) */}
          ...
          {/* Pro Tips Section - Only shown on mobile (order-3) */}
        ...
        <div className="max-w-4xl mx-auto mt-8">
          <div className="text-center mb-4">
            {/* Mobile: Show both buttons grouped together */}
            <div className="flex flex-row gap-2 justify-center items-center lg:hidden">
              <Button
                variant="outline"
                size="sm"
                onClick={handleSettingsClick}
                className="border-border/50 hover:border-primary transition-colors flex items-center"
              >
                <Settings className="w-4 h-4 mr-2" />
                API Settings
              </Button>
            ...
            {/* Desktop: Show only diagnostics button (API Settings is in header) */}
